...
%{?dlrn: %global tarsources python-ironic-prometheus-exporter}
%{!?dlrn: %global tarsources python_ironic_prometheus_exporter}
...
%changelog
* Fri Mar 14 2025 RDO <dev@lists.rdoproject.org> 4.5.0-1
- Update to 4.5.0
