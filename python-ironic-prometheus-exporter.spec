...
%{?dlrn: %global tarsources ironic-prometheus-exporter}
%{!?dlrn: %global tarsources ironic_prometheus_exporter}
...
Source0:    https://tarballs.openstack.org/%{library}/%{tarsources}-%{upstream_version}.tar.gz
# Required for tarball sources verification
%if 0%{?sources_gpg} == 1
Source101:        https://tarballs.openstack.org/%{library}/%{tarsources}-%{upstream_version}.tar.gz.asc
...
%changelog
# REMOVEME: error caused by commit https://opendev.org/openstack/ironic-prometheus-exporter/commit/728e698e5c79f9d5d630f8cdad60237fc93b98af
